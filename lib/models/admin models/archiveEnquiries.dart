class ArchiveEnquiriesModel {
  ...
  String? enqDateOfClosure;
  String? enqDateOfIssue;

  ArchiveEnquiriesModel(
      {this.id,
      this.userId,
      this.uniqueId,
      this.date,
      ...
      this.enqDateOfClosure,
      this.enqDateOfIssue});

  ArchiveEnquiriesModel.fromJson(Map<String, dynamic> json) {
    id = json['id'] ?? "";
    userId = json['user_id'] ?? "";
    ...
    enqDateOfClosure = json['enq_date_of_closure'] ?? "";
    enqDateOfIssue = json['enq_date_of_issue'] ?? "";
  }
}
