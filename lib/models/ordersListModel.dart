class OrdersModel {
  ...
  factory OrdersModel.fromJson(Map<String, dynamic> json) {
    ...
    return OrdersModel(
      quotationNumber: json['quotation_number'] ?? "NA",
      uniqueNumber: json['uniqueNumber'] ?? "NA",
      id: json['id'] ?? "NA",
      name: json['name'] ?? "NA",
      dileveryPostCodeC13: json['dilevery_post_code_c13'] ?? "NA",
      quoteDesc: json['quote_desc'] ?? "NA",
      telephoneNumber: json['telephone_number'] ?? "NA",
      customerEmail: json['customer_email'] ?? "NA",
      saleBonus: json['sale_bonus'] ?? "NA",
      wholeTotal: json['whole_total'] ?? "NA",
      thresholdType: json['threshold_type'] ?? "NA",
      marineGradeVal: json['marine_grade_val'] ?? "NA",
      frameSizeHeightWidth: json['frame_Size_height_Width'] ?? "NA",
      totalWeightKg: json['total_weight_kg'] ?? "NA",
      lhGoalPostE44: json['Lh_goal_post_e44'] ?? "NA",
      quotationDate: json['quotation_date'] ?? "NA",
      date: json['date'] ?? "NA",
      time: json['time'] ?? "NA",
      notes: json['notes'] ?? "NA",
      ankaDetailsInput: json['anka_details_input'] ?? "NA",
      ankaDetailsInput2: json['anka_details_input_2'] ?? "NA",
      ankaDetailsInput3: json['anka_details_input_3'] ?? "NA",
      ankaDetailsInput4: json['anka_details_input_4'] ?? "NA",
      ankaDetailsInput5: json['anka_details_input_5'] ?? "NA",
      ankaDetailsInput6: json['anka_details_input_6'] ?? "NA",
      ankaDetailsInput7: json['anka_details_input_7'] ?? "NA",
      ankaDetailsInput8: json['anka_details_input_8'] ?? "NA",
