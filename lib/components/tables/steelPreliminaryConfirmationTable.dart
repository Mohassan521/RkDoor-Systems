...
class SteelPreliminaryConfirmationTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  final String? empId;
  const SteelPreliminaryConfirmationTable(
      {super.key,
  ...
  @override
  State<SteelPreliminaryConfirmationTable> createState() =>
      _SteelPreliminaryConfirmationTableState();
}

class _SteelPreliminaryConfirmationTableState
    extends State<SteelPreliminaryConfirmationTable> {
  @override
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SteelOrderModel>? displayData = filteredList.isNotEmpty
            ? filteredList
            : preliminaryConfirmationList;

        return PaginatedDataTable(
            columnSpacing: 20,
            headingRowHeight: 48,
            dataRowMaxHeight: 48,
            rowsPerPage: (preliminaryConfirmationList.length > 5 &&
                    preliminaryConfirmationList.isNotEmpty)
                ? 5
                : preliminaryConfirmationList.isEmpty
                    ? 1
                    : preliminaryConfirmationList.length,
