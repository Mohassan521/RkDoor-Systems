...
class SteelReadyForShippingTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  const SteelReadyForShippingTable(
      {super.key, required this.dealerId, required this.dealerName});

  @override
  State<SteelReadyForShippingTable> createState() =>
      _SteelReadyForShippingTableState();
}

class _SteelReadyForShippingTableState
    extends State<SteelReadyForShippingTable> {
  @override
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        var readyForShippingList = list
            .where(
                (result) => result.steelOrderStatusVal == "Ready For Shipping")
            .toList();
