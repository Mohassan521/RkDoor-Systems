    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SteelOrderModel>? displayData =
            filteredList.isNotEmpty ? filteredList : steelOrderList;
        ...
        return ClipRRect(
          ...
          child: PaginatedDataTable(
              rowsPerPage:
                  (steelOrderList.length > 5 && steelOrderList.isNotEmpty)
                      ? 5
                      : steelOrderList.isEmpty
                          ? 1
                          : steelOrderList.length,
