...
class AdminSteelInProduction extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelInProduction(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelInProduction> createState() => _AdminSteelInProductionState();
}

class _AdminSteelInProductionState extends State<AdminSteelInProduction> {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        ...
        List<AdminSteelOrder> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.steelOrders!) {
              if (quote.steelOrderStatusVal == "In Production") {
