...
class AdminSteelAwaitingBalance extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelAwaitingBalance(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelAwaitingBalance> createState() =>
      _AdminSteelAwaitingBalanceState();
}

class _AdminSteelAwaitingBalanceState extends State<AdminSteelAwaitingBalance> {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        ...
        List<AdminSteelOrder> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.steelOrders!) {
              if (quote.steelOrderStatusVal == "Awaiting Balance") {
