...
class AdminSteelPCIssued extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelPCIssued(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelPCIssued> createState() => _AdminSteelPCIssuedState();
}

class _AdminSteelPCIssuedState extends State<AdminSteelPCIssued> {
...
class MyData extends DataTableSource {
  ...
  int get totalRowCount {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        if (quote.steelOrderStatusVal == 'Preliminary Confirmation Issued') {
          count++;
        }
      }
    }
