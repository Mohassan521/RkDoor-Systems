...
class AdminSteelOrdersReceived extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelOrdersReceived(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelOrdersReceived> createState() =>
      _AdminSteelOrdersReceivedState();
}

class _AdminSteelOrdersReceivedState extends State<AdminSteelOrdersReceived> {
      ...
      children: [
        ...
        FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            // List<AdminSteelOrder> filteredList = list!.where((result) => result.steelOrderStatusVal == "Order Received").toList();
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        ...
        List<AdminSteelOrder> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.steelOrders!) {
              if (quote.steelOrderStatusVal == "Order Received") {
