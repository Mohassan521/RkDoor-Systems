...
class AdminSteelAwaitingDeposit extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelAwaitingDeposit(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelAwaitingDeposit> createState() =>
      _AdminSteelAwaitingDepositState();
}

class _AdminSteelAwaitingDepositState extends State<AdminSteelAwaitingDeposit> {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        ...
        List<AdminSteelOrder> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.steelOrders!) {
              if (quote.steelOrderStatusVal == "Awaiting Deposit") {
