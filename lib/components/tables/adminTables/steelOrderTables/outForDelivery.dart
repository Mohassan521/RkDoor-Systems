...
class AdminSteelOutForDelivery extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelOutForDelivery(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelOutForDelivery> createState() =>
      _AdminSteelOutForDeliveryState();
}

class _AdminSteelOutForDeliveryState extends State<AdminSteelOutForDelivery> {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        ...
        List<AdminSteelOrder> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.steelOrders!) {
              if (quote.steelOrderStatusVal == "Out For Delivery") {
