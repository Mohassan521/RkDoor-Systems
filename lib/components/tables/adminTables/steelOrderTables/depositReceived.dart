...
class AdminSteelDepositReceived extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminSteelDepositReceived(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminSteelDepositReceived> createState() =>
      _AdminSteelDepositReceivedState();
}

class _AdminSteelDepositReceivedState extends State<AdminSteelDepositReceived> {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.steelOrders!) {
        ...
        List<AdminSteelOrder> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.steelOrders!) {
              if (quote.steelOrderStatusVal == "Deposit Received") {
