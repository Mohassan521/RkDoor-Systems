...
class AdminAllSteelOrders extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminAllSteelOrders(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminAllSteelOrders> createState() => _AdminAllSteelOrdersState();
}

class _AdminAllSteelOrdersState extends State<AdminAllSteelOrders> {
...
class MyData extends DataTableSource {
  ...
  int get totalRowCount {
    int count = 0;
    for (var dealerData in dealerDataList!) {
      count += dealerData.steelOrders!.length;
    }
    return count;
  }
}
