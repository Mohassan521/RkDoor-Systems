...
class AdminDoorAwaitingSurvey extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminDoorAwaitingSurvey(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminDoorAwaitingSurvey> createState() =>
      _AdminDoorAwaitingSurveyState();
}

class _AdminDoorAwaitingSurveyState extends State<AdminDoorAwaitingSurvey> {
