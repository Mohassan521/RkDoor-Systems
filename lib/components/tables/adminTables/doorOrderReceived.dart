...
class AdminDoorOrdersReceived extends StatefulWidget {
  ...
  final String? role;
  const AdminDoorOrdersReceived(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminDoorOrdersReceived> createState() =>
      _AdminDoorOrdersReceivedState();
}

class _AdminDoorOrdersReceivedState extends State<AdminDoorOrdersReceived> {
  ...
  void _showDatePicker() {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        // List<AdminPanelOrders> filteredlist = list!.where((result) => result.orderStatusVal == "Order Received").toList();
...
class MyData extends DataTableSource {
  ...
  List<AdminPanelOrders> getFilteredQuotes() {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.orders) {
        if (quote.orderStatusVal == "Order Received") {
