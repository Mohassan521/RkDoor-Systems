...
class AdminDoorInRKDS extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminDoorInRKDS(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminDoorInRKDS> createState() => _AdminDoorInRKDSState();
}

class _AdminDoorInRKDSState extends State<AdminDoorInRKDS> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        // List<AdminPanelOrders> filteredList = list!.where((result) => result.orderStatusVal == "In RKDS Warehouse").toList();
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.orders) {
        ...
        List<AdminPanelOrders> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.orders) {
              if (quote.orderStatusVal == "In RKDS Warehouse") {
