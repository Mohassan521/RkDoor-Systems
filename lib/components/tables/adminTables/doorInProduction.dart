...
class AdminDoorInProduction extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  const AdminDoorInProduction(
      {super.key, required this.dealerId, required this.dealerName});

  @override
  State<AdminDoorInProduction> createState() => _AdminDoorInProductionState();
}

class _AdminDoorInProductionState extends State<AdminDoorInProduction> {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.orders) {
        ...
        List<AdminPanelOrders> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.orders) {
              if (quote.orderStatusVal == "In Production") {
