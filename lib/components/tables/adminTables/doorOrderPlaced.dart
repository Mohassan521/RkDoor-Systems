...
class AdminDoorOrderPlaced extends StatefulWidget {
  ...
  const AdminDoorOrderPlaced(
      {super.key, required this.dealerId, required this.dealerName});

  @override
  State<AdminDoorOrderPlaced> createState() => _AdminDoorOrderPlacedState();
}

class _AdminDoorOrderPlacedState extends State<AdminDoorOrderPlaced> {
...
class MyData extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.orders) {
        if (quote.orderStatusVal == "Order Placed") {
