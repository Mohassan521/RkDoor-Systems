...
class AdminDoorAwaitingPayment extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminDoorAwaitingPayment(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminDoorAwaitingPayment> createState() =>
      _AdminDoorAwaitingPaymentState();
}

class _AdminDoorAwaitingPaymentState extends State<AdminDoorAwaitingPayment> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        // List<AdminPanelOrders> filteredList = list!.where((result) => result.orderStatusVal == "Awaiting Balance").toList();
    ...
    for (var dealerData in dealerDataList!) {
      for (var quote in dealerData.orders) {
        ...
        List<AdminPanelOrders> getFilteredQuotes() {
          ...
          for (var dealerData in dealerDataList!) {
            for (var quote in dealerData.orders) {
              if (quote.orderStatusVal == "Awaiting Balance") {
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: [
                        ...
                        DropdownMenuItem<String>(
                            ...
                            value: 'Delayed',
                            child:
                                Text('Delayed', textAlign: TextAlign.center)),
                      ],
                    ));
              })),
