...
class AdminDoorOutForDelivery extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  const AdminDoorOutForDelivery(
      {super.key, required this.dealerId, required this.dealerName, this.role});

  @override
  State<AdminDoorOutForDelivery> createState() =>
      _AdminDoorOutForDeliveryState();
}

class _AdminDoorOutForDeliveryState extends State<AdminDoorOutForDelivery> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        List<AdminPanelOrders> filteredList = list!.where((result) => result.orderStatusVal == "Out For Delivery").toList();
