...
class DoorDelayedTable extends StatefulWidget {
  final String? dealerId;
  final String? dealerName;
  const DoorDelayedTable({super.key, this.dealerId, this.dealerName});

  @override
  State<DoorDelayedTable> createState() => _DoorDelayedTableState();
}

class _DoorDelayedTableState extends State<DoorDelayedTable> {
      ...
      builder: (context, snapshot) {
        ...
        return Consumer<PaginationProvider>(builder: (context, value, child) {
          return PaginatedDataTable(
              rowsPerPage:
                  (doorDelayedList.length >= 5 && doorDelayedList.isNotEmpty)
                      ? 5
                      : (doorDelayedList.isEmpty)
                          ? 1
                          : doorDelayedList.length,
              ...
              source: MyData(list, doorDelayedList, _dateTime, widget.dealerId,
...
class MyData extends DataTableSource {
  ...
  MyData(this.data, this.doorDelayedList, this._datetime, this.dealerId,
      this.dealerName, this._showDatePicker,
      {required this.myGlobalBuildContext});

  @override
  int get rowCount => doorDelayedList.length;
  ...
  DataRow getRow(int index) {
    ...
    final OrdersModel result = doorDelayedList[index];
