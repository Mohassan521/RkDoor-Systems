...
class SteelOutForDeliveryTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  const SteelOutForDeliveryTable(
      {super.key, required this.dealerId, required this.dealerName});

  @override
  State<SteelOutForDeliveryTable> createState() =>
      _SteelOutForDeliveryTableState();
}

class _SteelOutForDeliveryTableState extends State<SteelOutForDeliveryTable> {
  @override
    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SteelOrderModel>? displayData =
            filteredList.isNotEmpty ? filteredList : outForDelivery;
        ...
        return ClipRRect(
          ...
          child: PaginatedDataTable(
              rowsPerPage:
                  (outForDelivery.length > 5 && outForDelivery.isNotEmpty)
                      ? 5
                      : outForDelivery.isEmpty
                          ? 1
