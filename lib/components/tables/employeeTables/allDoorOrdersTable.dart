...
class AllDoorOrdersTableForEmployees extends StatefulWidget {
  final String? dealerId;
  final String? dealerName;
  const AllDoorOrdersTableForEmployees(
      {super.key, this.dealerId, this.dealerName});

  @override
  State<AllDoorOrdersTableForEmployees> createState() =>
      _AllDoorOrdersTableForEmployeesState();
}

class _AllDoorOrdersTableForEmployeesState
    extends State<AllDoorOrdersTableForEmployees> {
...
class MyData extends DataTableSource {
  ...
  AllDoorOrdersTableForEmployees table = AllDoorOrdersTableForEmployees();
