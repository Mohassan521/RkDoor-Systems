...
class SteelAwaitingDepositTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  const SteelAwaitingDepositTable(
      {super.key, required this.dealerId, required this.dealerName});

  @override
  State<SteelAwaitingDepositTable> createState() =>
      _SteelAwaitingDepositTableState();
}

class _SteelAwaitingDepositTableState extends State<SteelAwaitingDepositTable> {
  @override
    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SteelOrderModel>? displayData =
            filteredList.isNotEmpty ? filteredList : awaitingDeposit;
        ...
        return ClipRRect(
          ...
          child: PaginatedDataTable(
              rowsPerPage:
                  (awaitingDeposit.length > 5 && awaitingDeposit.isNotEmpty)
                      ? 5
                      : awaitingDeposit.isEmpty
                          ? 1
