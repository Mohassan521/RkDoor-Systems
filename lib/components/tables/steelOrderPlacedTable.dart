...
class SteelOrderPlacedTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  final String? empId;
  const SteelOrderPlacedTable(
      {super.key, required this.dealerId, required this.dealerName, this.empId, this.role});

  @override
  State<SteelOrderPlacedTable> createState() => _SteelOrderPlacedTableState();
}

class _SteelOrderPlacedTableState extends State<SteelOrderPlacedTable> {
  @override
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        var steelOrderPlacedList = list
            .where((result) => result.steelOrderStatusVal == "Order Placed")
            .toList();
        ...
        return ClipRRect(
          ...
          child: PaginatedDataTable(
              rowsPerPage: (steelOrderPlacedList.length > 5 &&
                      steelOrderPlacedList.isNotEmpty)
                  ? 5
                  : steelOrderPlacedList.isEmpty
                      ? 1
                      : steelOrderPlacedList.length,
              ...
              source: MyData(steelOrderPlacedList, context, widget.dealerId,
