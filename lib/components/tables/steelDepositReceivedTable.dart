...
class SteelDepositReceivedTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final String? role;
  final String? empId;
  const SteelDepositReceivedTable(
      {super.key, required this.dealerId, required this.dealerName, this.empId, this.role});

  @override
  State<SteelDepositReceivedTable> createState() =>
      _SteelDepositReceivedTableState();
}

class _SteelDepositReceivedTableState extends State<SteelDepositReceivedTable> {
  @override
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SteelOrderModel>>(
      ...
      builder: (context, snapshot) {
        ...
        var depositReceivedList = list
            .where((result) => result.steelOrderStatusVal == "Deposit Received")
            .toList();
