...
class DoorOrderReceivedTable extends StatefulWidget {
  ...
  const DoorOrderReceivedTable({super.key, this.dealerId, this.dealerName});

  @override
  State<DoorOrderReceivedTable> createState() => _DoorOrderReceivedTableState();
}

class _DoorOrderReceivedTableState extends State<DoorOrderReceivedTable> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<OrdersModel>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersModel> orderReceivedList = list
            .where((result) => result.orderStatusVal == "Order Received")
            .toList();
        ...
        return Consumer<PaginationProvider>(builder: (context, value, child) {
          return PaginatedDataTable(
              ...
              source: MyData(list, orderReceivedList, _dateTime,
...
class MyData extends DataTableSource {
  ...
  MyData(this.data, this.orderReceivedList, this._datetime, this.dealerId,
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: <DataCell>[
        ...
        DataCell(Text(result.manualQuickDocumentUpload!
            .map((e) => e.toString())
            .join(', '))),
