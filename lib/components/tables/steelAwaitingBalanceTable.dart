...
class SteelAwaitingBalanceTable extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  const SteelAwaitingBalanceTable(
      {super.key, required this.dealerId, required this.dealerName});

  @override
  State<SteelAwaitingBalanceTable> createState() =>
      _SteelAwaitingBalanceTableState();
}

class _SteelAwaitingBalanceTableState extends State<SteelAwaitingBalanceTable> {
  @override
