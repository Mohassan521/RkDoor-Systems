          ...
          child: Column(
            children: [
              Container(
                ...
                child: FutureBuilder(
                  future: apiServices.getCEDDetailsEight(),
                  builder: (context, snapshot) {
                    ...
                    List<TechnicalAndWiringModel>? bimdetails = snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        TechnicalAndWiringModel dataSheets = bimdetails[index];
                        List<TechnicalWiringFileData> files = dataSheets.files;
                        return Column(
                          children: [
                            SizedBox(
                              height: 20,
                                                                    ...
                                                                    Form(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        RoundButton(
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            apiServices.updateDirectoryName7(dataSheets.id,
                                                                                value.text);
                            ...
                            Column(
                              ...
                              children: [
                                for (TechnicalWiringFileData file in files)
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        left: 8.0, top: 5),
                                    child: Slidable(
