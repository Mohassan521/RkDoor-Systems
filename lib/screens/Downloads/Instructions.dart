                              ...
                              Form(
                                ...
                                children: [
                                  ...
                                  RoundButton(
                                    ...
                                    onTap: () async {
                                      apiServices
                                          .addInsideFolder4(category.text);
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: FutureBuilder(
                    future: apiServices.getCEDDetailsFive(),
                    builder: (context, snapshot) {
                      ...
                      List<InstructionsModel>? bimdetails = snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          InstructionsModel cadDetails = bimdetails[index];
                          List<instructionsFileData> files = cadDetails.files;
                          ...
                          return Column(
                            children: [
                                                                      ...
                                                                      Form(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          RoundButton(
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              apiServices.updateDirectoryName4(cadDetails.id, value.text);
                                                                  ...
                                                                  children: [
                                                                    RoundButton(
                                                                      ...
                                                                      onTap:
                                                                          () {
                                                                        apiServices
                                                                            .deleteWholeDirectory4(cadDetails.id);
                                                                        Navigator.pop(
                                                                            context);
                                                                      },
                                                                      color: Colors
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          RoundButton(
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              apiServices.addSubFolders4(cadDetails.name, numberController.text, descController.text, filesToUpload);
                              ...
                              Column(
                                ...
                                children: [
                                  for (instructionsFileData file in files)
                                    Padding(
