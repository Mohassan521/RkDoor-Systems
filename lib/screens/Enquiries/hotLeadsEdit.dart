...
class EditHotLeads extends StatefulWidget {
  final String dealerId;
  final String dealerName;
  final HotLeadsModel hotLeadsModel;
  const EditHotLeads(
      {super.key,
      required this.dealerId,
      required this.dealerName,
      required this.hotLeadsModel});

  @override
  State<EditHotLeads> createState() => _EditHotLeadsState();
}

class _EditHotLeadsState extends State<EditHotLeads> {
  //String? _filePath;
  ...
  Widget build(BuildContext context) {
    ...
    String entranceDoorValue =
        widget.hotLeadsModel.enquiryType ?? "Entrance Door";
    String enquirySourceValue =
        widget.hotLeadsModel.enquirySource ?? "Instagram";
    String requirementValue =
        widget.hotLeadsModel.enquiryRequirement ?? "Call Back";
    String supplyTypeValue =
        widget.hotLeadsModel.enquirySupplyType ?? "supply only";
    String priorityValue = widget.hotLeadsModel.enquiryPriorityLevel ?? "LOW";
    String enquiryEnteredBy = "Alecia";
    dealerController.text = dealerData.dealerName!;
    cusNameController.text = widget.hotLeadsModel.enquiryCusName ?? "";
    companyController.text = widget.hotLeadsModel.enquiryCompanyName ?? "";

    deliveryAddressController.text = widget.hotLeadsModel.customerAddress ?? "";
    deliveryAddressController2.text =
        widget.hotLeadsModel.customerAddress2 ?? "";
    deliveryAddressController3.text =
        widget.hotLeadsModel.customerAddress3 ?? "";
    deliveryAddressController4.text =
        widget.hotLeadsModel.customerAddress4 ?? "";
    deliveryPostCode.text = widget.hotLeadsModel.dileveryPostCodeC13 ?? "";
    emailController.text = widget.hotLeadsModel.enquiryCusEmail ?? "";
    telephoneController.text = widget.hotLeadsModel.enquiryTelNum ?? "";

    notesController.text = widget.hotLeadsModel.enquiryNotes ?? "";
    return Scaffold(
      drawer: DrawerPage(
            ...
            children: [
              ...
              DropdownButton<String>(
                ...
                onChanged: (String? newValue) {
                  setState(() {
                    widget.hotLeadsModel.enquiryType = newValue!;
                  });
                },
                items: [
