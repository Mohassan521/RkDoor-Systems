...
class DoorOnHold extends StatefulWidget {
  ...
  const DoorOnHold({super.key, required this.dealerId});

  @override
  State<DoorOnHold> createState() => _DoorOnHoldState();
}

class _DoorOnHoldState extends State<DoorOnHold> {
