...
class SteelReadyForShipping extends StatefulWidget {
  ...
  @override
  State<SteelReadyForShipping> createState() => _SteelReadyForShippingState();
}

class _SteelReadyForShippingState extends State<SteelReadyForShipping> {
          ...
          children: [
            ...
            Padding(
              ...
              child: widget.role == "admin"
                  ? AdminSteelReadyForShipping(
                      dealerId: widget.dealerId,
                      dealerName: widget.dealerName,
                      role: widget.role,
                    )
                  : SteelReadyForShippingTable(
