...
class OrdersAllocation extends StatefulWidget {
  ...
  final String? role;
  const OrdersAllocation(
      {super.key, this.dealerId, this.dealerName, this.role});

  @override
  State<OrdersAllocation> createState() => _OrdersAllocationState();
}

class _OrdersAllocationState extends State<OrdersAllocation> {
  @override
